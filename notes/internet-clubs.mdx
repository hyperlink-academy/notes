...
<SpotImage
  alt="an sketch of a club fair, with people at tables and banners, and a people walking around, talking to each other, and looking at the tables"
  src="/images/internet-clubs/cover.png"
  noTopMargin
  className="w-[1200px]  mb-4"
/>
