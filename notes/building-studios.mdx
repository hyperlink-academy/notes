export const metadata = {
  ...
  description:
    "we added a new layer of Hyperlink's learning infrastructure, Studios: environments for groups to share and explore projects together",
  author: "Brendan",
...
<Quote>
  What would it look like to have your own campus, where you could step through
  a gate and join any class, start any club, explore any question, at any time?
</Quote>
...
![](/images/building-studios/building-studios-spaces-studios.png)

<Caption>Do your work in a Space. Situate your Space in a Studio.</Caption>
...
<VisualPlaceholder>
  DIAGRAM: simplified wireframe of a Studio homepage? **or TBD maybe something
  else (e.g. types of Studios?)**
</VisualPlaceholder>

We see Studios as useful environments for creative clubs, friend groups with shared hobbies, teams doing projects together, and other communities of practice.
...
_Hex House. Logic School. Future of Coding. Interintellect. Maximum New York. Index. HTML Energy. Recurse Center. Other Internet. Summer of Protocols. Afrotectopia. Orange Tangent Study. Bad Quarto. Reboot. Interact. SFPC. Library Innovation Lab. Lifelong Kindergarten._
...
<CTA>
You can try an early version of Studios — <a href="https://hyperlink.academy/signup">sign up for Hyperlink</a>, and make
a new Studio from the header.
...
![](/images/building-studios/building-studios-flow.png)

<Caption>
  Build supportive communities around your projects to create cycles of progress
  and learning.
</Caption>
...
Inspired by the [Internet Homesteading](https://year-one.hyperlink.academy/courses/internet-homesteading/22) course Jared taught in Hyperlink's early days, this Studio might sit somewhere between a school and a community of practice. It could encompass facilitated experiences like a course, personal projects, related events like Jared's [website tours](https://youtube.com/playlist?list=PLEXbN99LY3OCarUeXcxWeZzOelXQvVdAA), and more emergent peer-driven explorations.
...
![](/images/building-studios/building-studios-studio.png)

<Caption>
  The Internet Homesteading studio is full of all kinds of personal and group
  activity that interact and exist together.
</Caption>
...
<Quote>
  What would it look like to build your own bespoke learning environment?
</Quote>
...
![](/images/building-studios/building-studios-learning-network.png)

<Caption>The learner ecosystem is complex, nuanced, and fluid!</Caption>
