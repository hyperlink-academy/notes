export const metadata = {
  ...
  description:
    "a new layer in Hyperlink's learning infrastructure, Studios: environments for groups to share and explore projects together",
  author: "Brendan",
...
<CTA>
You can try an early version of Studios — <a href="https://hyperlink.academy/signup">sign up for Hyperlink</a>, make a Studio from the header, add Spaces, invite friends.
...
<Caption>
  The Internet Homesteading Studio hums with activity: projects, groups, clubs,
  cohorts, co-existing in a shared environment.
</Caption>
...
<Caption>Learners' ecosystems are complex, nuanced, and fluid!</Caption>
